  ...
  <header id="header" role="banner" class="pam">
    ...
    habitant schnaps ante et sit leo schpeck sit Salu bissame Salut bisamme varius quam.
      ...
      <ul class="pam txtcenter">
        <li class="inbl mam pas txtcenter">Picon bière</li>
        <li class="inbl mam pas txtcenter">Melfor</li>
        <li class="inbl mam pas txtcenter">Carola</li>
        <li class="inbl mam pas txtcenter">Kuglof</li>
        <li class="inbl mam pas txtcenter">Wurscht</li>
      </ul>
    </nav>
  </header>
